...
public class VendorTeamLead {
  ...
  @Test
	public void testSiteAdminLogin() throws Exception {
		...
		String page = "Vendor Team Lead Login";
		String ruleId = "vendorTeamLead";
		String userName = "Vendor Team Lead Login";
		String password = "";
		String event_id = "";
		...
		try {
			...
			MSBUtils.userLogin(driver, "dsammy@ibsplc.com", "Msb1234");
    
    
//    driver.findElement(By.linkText("Sign in")).click();
////    driver.findElement(By.cssSelector("div.modal-body > #userLoginForm > div.logCredential > #emailId")).clear();
//    driver.findElement(By.cssSelector("div.modal-body > #userLoginForm > div.logCredential > #emailId")).sendKeys("jameslee@ibsplc.com");
...
//    driver.findElement(By.cssSelector("#userLoginForm > div.LoginButton > button[type=\"submit\"]")).click();
			successMessage += "Success Vendor Team Lead Login ";
			timetoProcess += "" + (new Date().getTime() - beging.getTime())
					/ 1000;

		} catch (Exception e) {
			returnvalue = false;
			System.out.println("Error in Vendor Team Lead Login .. ");
			StringWriter errors = new StringWriter();
			e.printStackTrace(new PrintWriter(errors));
			errorMessage += " Error in Vendor Team Lead Login "
					+ errors.toString();
