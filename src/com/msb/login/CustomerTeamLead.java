...
public class CustomerTeamLead {
  ...
  @Test
	public void testSiteAdminLogin() throws Exception {
		...
		String page = "Customer Team Lead Login";
		String ruleId = "customerTeamLeadLogin";
		String userName = "Customer Team Lead Login";
		String password = "";
		String event_id = "";
...
//    driver.findElement(By.cssSelector("div.modal-body > #userLoginForm > div.logCredential > #emailId")).sendKeys("nseerapu@interfaceglobal.com");
...
//    driver.findElement(By.cssSelector("#userLoginForm > div.LoginButton > button[type=\"submit\"]")).click();
			...
			returnvalue = false;
			System.out.println("Error in Customer Team Lead Login .. ");
			StringWriter errors = new StringWriter();
			e.printStackTrace(new PrintWriter(errors));
			errorMessage += " Error in Customer Team Lead Login "
					+ errors.toString();
