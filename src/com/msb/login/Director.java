...
public class Director {
  ...
  @Test
	public void testSiteAdminLogin() throws Exception {
		...
		String page = "Director Login";
		String ruleId = "directorLogin";
		String userName = "Director Login";
		String password = "";
		String event_id = "";
...
//    driver.findElement(By.cssSelector("div.modal-body > #userLoginForm > div.logCredential > #emailId")).sendKeys("keron@interfaceglobal.com");
...
//    driver.findElement(By.cssSelector("#userLoginForm > div.LoginButton > button[type=\"submit\"]")).click();
			successMessage += "Success Director Login ";
			timetoProcess += "" + (new Date().getTime() - beging.getTime())
					/ 1000;

		} catch (Exception e) {
			returnvalue = false;
			System.out.println("Error in Director Login .. ");
			StringWriter errors = new StringWriter();
			e.printStackTrace(new PrintWriter(errors));
			errorMessage += " Error in Director Login "
					+ errors.toString();
