...
public class VendorAdmin {
  ...
  @Test
	public void testSiteAdminLogin() throws Exception {
		...
		String page = "Vendor Admin Login";
		String ruleId = "vendorAdminLogin";
		String userName = "Vendor Admin Login";
		String password = "";
		String event_id = "";
		...
		try {
			...
			MSBUtils.userLogin(driver, "vkandregula@ibsplc.com", "Msb1234");
    
//    driver.findElement(By.linkText("Sign in")).click();
////    driver.findElement(By.cssSelector("div.modal-body > #userLoginForm > div.logCredential > #emailId")).clear();
//    driver.findElement(By.cssSelector("div.modal-body > #userLoginForm > div.logCredential > #emailId")).sendKeys("vkandregula@ibsplc.com");
...
//    driver.findElement(By.cssSelector("#userLoginForm > div.LoginButton > button[type=\"submit\"]")).click();
			successMessage += "Success Vendor Admin Login ";
			timetoProcess += "" + (new Date().getTime() - beging.getTime())
					/ 1000;

		} catch (Exception e) {
			returnvalue = false;
			System.out.println("Error in Vendor Admin Login .. ");
			StringWriter errors = new StringWriter();
			e.printStackTrace(new PrintWriter(errors));
			errorMessage += " Error in Vendor Admin Login "
					+ errors.toString();
