...
public class ProjectManager {
  ...
  @Test
	public void testSiteAdminLogin() throws Exception {
		...
		String page = "Project Manager Login";
		String ruleId = "projectManagerLogin";
		String userName = "Project Manager Login";
		String password = "";
		String event_id = "";
...
//    driver.findElement(By.cssSelector("div.modal-body > #userLoginForm > div.logCredential > #emailId")).sendKeys("vsiram@interfaceglobal.com");
...
//    driver.findElement(By.cssSelector("#userLoginForm > div.LoginButton > button[type=\"submit\"]")).click();
  successMessage += "Success Project Manager Login ";
	timetoProcess += "" + (new Date().getTime() - beging.getTime())
			/ 1000;

} catch (Exception e) {
	returnvalue = false;
	System.out.println("Error in Project Manager Login .. ");
	StringWriter errors = new StringWriter();
	e.printStackTrace(new PrintWriter(errors));
	errorMessage += " Error in Project Manager Login "
			+ errors.toString();
