...
public class Manager {
  ...
  @Test
 	public void testSiteAdminLogin() throws Exception {
 		...
 		String page = "Manager Login";
 		String ruleId = "managerLogin";
 		String userName = "Manager Login";
 		String password = "";
 		String event_id = "";
...
//    driver.findElement(By.cssSelector("#userLoginForm > div.LoginButton > button[type=\"submit\"]")).click();
 			successMessage += "Success Manager Login ";
			timetoProcess += "" + (new Date().getTime() - beging.getTime())
					/ 1000;

		} catch (Exception e) {
			returnvalue = false;
			System.out.println("Error in Manager Login .. ");
			StringWriter errors = new StringWriter();
			e.printStackTrace(new PrintWriter(errors));
			errorMessage += " Error in Manager Login "
					+ errors.toString();
